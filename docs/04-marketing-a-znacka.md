# 4. Marketing a značka

> Jak přivést první zákaznice, a jak vypadat důvěryhodně, i když začínáš.
> Méně „značkového lesku“, víc reálných prodejů.
...
## Kde získat první zákaznice (vyber 1–2, ne všechno)
...
## Důvěra = konverze (zadarmo a zásadní)

Lidé nekoupí, když ti nevěří. Přidej:
- Reálné **fotky** produktu (ne jen od dodavatele)
- **Recenze** a reálné objednávky (i pár stačí)
- Viditelný **kontakt** a info o **dopravě a vrácení**
- **O nás / příběh** s tvojí tváří

## Marketing a rozpočet

Kolik dávat do reklamy? Orientačně **10–20 % obratu** (podle oboru, viz
[kalkulačka](https://hzb.davidjose.net/kalkulacka)). Ale na **start a ověření**
nepotřebuješ placenou reklamu. Potřebuješ prvních pár reálných zákaznic z
neplacených kanálů.
...
> - [`prompts/marketing-plan.md`](../prompts/marketing-plan.md): plán obsahu na 2 týdny pro tvou personu

Tip: vždy AI nakrm **svojí personou** ([validace](01-validace.md)). „Napiš popisek pro
[personu], která řeší [problém]“ dá mnohem lepší text než obecné zadání.

→ Pokračuj na [5. Provoz a finance](05-provoz-a-finance.md).
